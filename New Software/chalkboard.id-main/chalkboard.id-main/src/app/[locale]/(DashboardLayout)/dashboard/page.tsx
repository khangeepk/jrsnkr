...
import MembershipExpiredPopup from "@/components/MembershipExpiredPopup";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {tables.map((table) => {
            ...
            return (
              <div
                key={table.id}
                className={`p-4 rounded-lg border-2 transition-all ${isOccupied
...
export default JRSnookerDashboard; 