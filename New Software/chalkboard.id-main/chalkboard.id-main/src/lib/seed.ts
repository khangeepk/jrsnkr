...
export async function seedDatabase() {
  try {
    ...
    const sampleUsers = [
      { name: 'JR Snooker Admin', email: 'admin@jrsnooker.com', role: 'admin', password: 'hashed_password_1' },
      { name: 'Manager Rahul', email: 'rahul@jrsnooker.com', role: 'manager', password: 'hashed_password_2' },
      { name: 'Staff Hamza', email: 'hamza@jrsnooker.com', role: 'staff', password: 'hashed_password_3' },
      { name: 'Staff Zara', email: 'zara@jrsnooker.com', role: 'staff', password: 'hashed_password_4' },
      { name: 'Staff Bilal', email: 'bilal@jrsnooker.com', role: 'staff', password: 'hashed_password_5' },
      { name: 'Staff Nadia', email: 'nadia@jrsnooker.com', role: 'staff', password: 'hashed_password_6' },
    ];
