    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Toggle Icon   */}
          <Navbar.Collapse className="lg:block ">
          ...
          {/* Mobile Toggle Icon */}
          <span
            className="h-10 w-10 flex lg:hidden hover:text-primary hover:bg-lightprimary rounded-full justify-center items-center cursor-pointer"
        ...
        <div
          className={`w-full  lg:hidden block mobile-header-menu ${mobileMenu}`}
        >
          <MobileHeaderItems />
        </div>
        ...
        {/* Horizontal Menu  */}
        {layoutType == "horizontal" ? (
          <div className="lg:border-t lg:border-ld">
            <div
