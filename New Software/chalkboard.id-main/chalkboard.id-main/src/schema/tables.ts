import { pgTable, serial, varchar, decimal, boolean, timestamp, integer, uuid, text } from 'drizzle-orm/pg-core';
...
export const tableSessions = pgTable('table_sessions', {
  ...
  gameType: varchar('game_type', { length: 30 }).default('single'), // game type from frontend
  players: text('players'), // JSON string of players
